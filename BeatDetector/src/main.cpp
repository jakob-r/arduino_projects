...
void setup() {
    ...
    p.AddTimeGraph("value", 1000, "value", value);
    p.AddTimeGraph("envelope", 1000, "envelope", envelope);
    p.AddTimeGraph("beat", 1000, "beat", beat);
    p.AddTimeGraph("thresh", 1000, "thresh", thresh);
}
